    ...
    if (isWifiConfig) {
      ...
      // Serve dashboard.html (embedded as a string for now)
        ...
        webClient.println("<div class=\"fan-state\">Fan State: <span id=\"fan\">-</span></div>");
          ...
          webClient.println("<form class=\"threshold-form\" onsubmit=\"return setThreshold(event)\"><h3>Fan ON Threshold</h3><input type=\"number\" id=\"threshold\" min=\"400\" max=\"5000\" step=\"1\"> ppm <button class=\"threshold-btn\" type=\"submit\">Set</button><span id=\"threshold-status\" style=\"margin-left:1rem;font-size:1rem;\"></span></form><div style='margin-top:0.5rem;font-size:1rem;color:#d32f2f;'>Safe CO2 level is below 800</div>");
